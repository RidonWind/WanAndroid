class ProjectTreeModel {
  ...
  ProjectTreeModel.fromJson(Map<String, dynamic> json) {
    if (json["data"] is List) {
      data = json["data"] == null
          ? null
          : (json["data"] as List)
              .map((e) => ProjectTreeSeed.fromJson(e))
              .toList();
    }
  ...
  static List<ProjectTreeModel> fromList(List<Map<String, dynamic>> list) {
    return list.map(ProjectTreeModel.fromJson).toList();
  }
...
class ProjectTreeSeed {
  ...
  ProjectTreeSeed.fromJson(Map<String, dynamic> json) {
  ...
  static List<ProjectTreeSeed> fromList(List<Map<String, dynamic>> list) {
    return list.map(ProjectTreeSeed.fromJson).toList();
  }
