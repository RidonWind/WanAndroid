class WechatArticleModel {
  WechatArticleChild? data;
  int? errorCode;
  String? errorMsg;

  WechatArticleModel({this.data, this.errorCode, this.errorMsg});

  WechatArticleModel.fromJson(Map<String, dynamic> json) {
    if (json["data"] is Map) {
      data = json["data"] == null
          ? null
          : WechatArticleChild.fromJson(json["data"]);
    }
  ...
  static List<WechatArticleModel> fromList(List<Map<String, dynamic>> list) {
    return list.map(WechatArticleModel.fromJson).toList();
  }
...
class WechatArticleChild {
  int? curPage;
  List<WechatArticleSeed>? datas;
  int? offset;
  bool? over;
  int? pageCount;
  int? size;
  ...
  WechatArticleChild.fromJson(Map<String, dynamic> json) {
    ...
    if (json["datas"] is List) {
      datas = json["datas"] == null
          ? null
          : (json["datas"] as List)
              .map((e) => WechatArticleSeed.fromJson(e))
              .toList();
    }
  ...
  static List<WechatArticleChild> fromList(List<Map<String, dynamic>> list) {
    return list.map(WechatArticleChild.fromJson).toList();
  }
...
class WechatArticleSeed {
  ...
  WechatArticleSeed.fromJson(Map<String, dynamic> json) {
  ...
  static List<WechatArticleSeed> fromList(List<Map<String, dynamic>> list) {
    return list.map(WechatArticleSeed.fromJson).toList();
  }
