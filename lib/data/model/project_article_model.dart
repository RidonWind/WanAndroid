class ProjectArticleListModel {
  ProjectArticleListSeed? data;
  int? errorCode;
  String? errorMsg;
  ...
  ProjectArticleListModel.fromJson(Map<String, dynamic> json) {
    if (json["data"] is Map) {
      data = json["data"] == null
          ? null
          : ProjectArticleListSeed.fromJson(json["data"]);
    }
  ...
  static List<ProjectArticleListModel> fromList(
      List<Map<String, dynamic>> list) {
    return list.map(ProjectArticleListModel.fromJson).toList();
  }
...
class ProjectArticleListSeed {
  int? curPage;
  List<ProjectArticleSeed>? datas;
  int? offset;
  bool? over;
  int? pageCount;
  int? size;
  ...
  ProjectArticleListSeed.fromJson(Map<String, dynamic> json) {
    ...
    if (json["datas"] is List) {
      datas = json["datas"] == null
          ? null
          : (json["datas"] as List)
              .map((e) => ProjectArticleSeed.fromJson(e))
              .toList();
    }
  ...
  static List<ProjectArticleListSeed> fromList(
      List<Map<String, dynamic>> list) {
    return list.map(ProjectArticleListSeed.fromJson).toList();
  }
...
class ProjectArticleSeed {
  ...
  ProjectArticleSeed.fromJson(Map<String, dynamic> json) {
  ...
  static List<ProjectArticleSeed> fromList(List<Map<String, dynamic>> list) {
    return list.map(ProjectArticleSeed.fromJson).toList();
  }
